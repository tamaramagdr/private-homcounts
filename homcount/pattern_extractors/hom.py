...
def compute_hom(passed_args=None):
    ...
    parser.add_argument('--min_treewidth', type=int, default=None)
    ...
    parser.add_argument('--add_small_patterns', action="store_true", default=False)
    parser.add_argument('--get_cycles', action="store_true", default=False)
    ...
    try:
        ...
        with precompute_patterns_file_handle(args.data.upper(), args.hom_type, args.hom_size, args.pattern_count, args.run_id, args.oloc) as f:
            ...
            homX = hom_func(graphs,
                            ...
                            min_treewidth=args.min_treewidth,
                            density=False, 
                            seed=args.seed, 
                            pattern_count=args.pattern_count, 
                            pattern_file=f,
                            small_patterns=args.add_small_patterns,
                            get_cycles=args.get_cycles,
                            )
        ...
        try:
            print(load_precompute_patterns(args.data.upper(), args.hom_type, args.hom_size, args.pattern_count, args.run_id, args.oloc))
